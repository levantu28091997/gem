                ...
                {isMobile
                    ...
                    <div className="">
                        <div className="w-[280px] mx-auto">
                            <AboutTitleSection title="Dive Into A World Of Gaming Experiences" lineheight="31px" size="30px" fontStyle="italic" className="text-white" />
                        </div>
                        <p data-aos="fade-up" data-aos-duration="3000" className="text-center pt-[14px] w-full font-[400] text-white font-['Montserrat']">We offer a wide variety of games that cater to all ages and interests. Our user-friendly interface makes it easy to browse and select your favorite games, while our site is updated regularly with new content every hours.</p>
                    </div>
                    : <div className="w-[560px] mx-auto">
                        <AboutTitleSection title="Dive Into A World Of Gaming Experiences" lineheight="63px" size="60px" fontStyle="italic" className="text-white" />
                        <p data-aos="fade-up" data-aos-duration="3000" className="text-center text-[14px] pt-[19px]  text-white font-['Montserrat']">We offer a wide variety of games that cater to all ages and interests. Our user-friendly interface makes it easy to browse and select your favorite games, while our site is updated regularly with new content every hours.</p>
                    </div>
                }
                {/* Contetnt */}
                    ...
                    <div className={isMobile ? "pt-[192px]" : isTablet ? "pt-[400px]" : "pt-[20%]"}>
                        {dataMember.map((item) =>
                            <div className={isMobile ? "text-center mb-6" : isTablet ? "text-center mb-1" : "text-center mb-16"}>
                                <AboutTitleSection className="text-white" title={<NumberAnimation n={item.amount} />} size={isMobile ? "60px" : isTablet ? "100px" : "100px "} lineheight={isMobile ? "30.72px" : isTablet ? "normal" : "normal"} />
