                    ...
                    <div className="w-full mt-[51px] mb-[51px]">
                        <div className="flex justify-between">
                            ...
                            <div className="mb-[33px] mt-5 mr-[28%]">
                                <AboutTitleSection className="text-white" title="FAQ" size={isMobile ? "32px" : isTablet ? "32px" : "50px"} />
                            </div>
                        </div>
                ...
                : isTablet ?
                        ...
                        <div className="w-full flex justify-between mt-[51px] mb-[161px] z-[1]">
                            ...
                            <div className="w-1/2">
                                <div className="mb-[33px] mt-5">
                                    <AboutTitleSection className="text-white" title="FAQ" size="50px" />
                                </div>
                                {dataText.map((item, i) =>
                                    <FaqItem faq={item} index={i} OpenFaq={Open} />
                                )}
                    ...
                    : <div className="">
                        <div className="w-full flex justify-between mt-[51px] mb-[161px]">
                            ...
                            <div className="w-1/2">
                                <div className="mb-[33px] -mt-5">
                                    <AboutTitleSection className="text-white" title="FAQ" size={isMobile ? "" : isTablet ? "" : "50px"} />
                                </div>
                                {dataText.map((item, i) =>
                                  <FaqItem faq={item} index={i} OpenFaq={Open} />
                                )}
